...
func (_m *Business) GetAllBillIssuer(_a0 billissuer.BillIssuerCore) ([]billissuer.BillIssuerCore, error) {
	ret := _m.Called(_a0)
...
func (_m *Business) GetBillIssuerById(id int) (billissuer.BillIssuerCore, error) {
	ret := _m.Called(id)
...
func (_m *Business) LoginBillIssuer(data billissuer.BillIssuerCore) (billissuer.BillIssuerCore, error) {
	ret := _m.Called(data)
...
func (_m *Business) UpdateBillIssuer(data billissuer.BillIssuerCore) error {
	ret := _m.Called(data)
